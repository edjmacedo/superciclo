...
wb.cadastroencaminhamentouser = {
	init: function(){
		...
		service.getClinicas(function(data) {
                    wb.cadastroencaminhamentouser.render(data);
		});		
                wb.cadastroencaminhamentouser.bind();
            }else{
	...
	render: function(data){            
	  ...
	  document.getElementById('cadastroencaminhamentouser').innerHTML = template.ComponentaddEncaminhamentos.replace("{CHECKED}", "checked")
