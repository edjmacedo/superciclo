                    ...
                    success: function(data) {                                             
                        ...
                        for(x = 0; x < 1; x++){                           
                            ...
                            activity += template.ComponentEditEncaminhamentos.replace(tag, "checked")
                                ...
                                .replace("{CHK}", aso)
                                .replace("{CHK02}", colesterol)
                                .replace("{CHK03}", audiometria)
                                .replace("{CHK04}", triglicerideos)
                                .replace("{CHK05}", hemograma)
                                .replace("{CHK06}", raiox)
                                .replace("{CHK07}", eas)
                                .replace("{CHK08}", vectoeletro)
                                .replace("{CHK09}", epf)
                                .replace("{CHK10}", tipagem)
                                .replace("{CHK11}", vdrl)
                                .replace("{CHK12}", tgo)
                                .replace("{CHK13}", glicose)
                                .replace("{CHK14}", espirometria)
                                .replace("{CHK15}", betahcg)
                                .replace("{CHK16}", eletroencefalo)
                                .replace("{CHK17}", dosagem)
